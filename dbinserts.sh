...
#-x
echo""
read -p "Press any key to perform datbase inserts" -n 1 -s
...
echo""
read -p "Press any key to continue inserts" -n 1 -s
mysql -u haproxy --host=192.168.144.20 -e 'insert into NASA.persons ( id, LastName, FirstName, City, State) values (7, "Aaron", "John", "Houston", "TX");'
echo""
read -p "Press any key to continue inserts" -n 1 -s
mysql -u haproxy --host=192.168.144.20 -e 'insert into NASA.persons ( id, LastName, FirstName, City, State) values (8, "Griffin", "Jerry", "Houston", "TX");'
echo""
read -p "Press any key to continue inserts" -n 1 -s
mysql -u haproxy --host=192.168.144.20 -e 'insert into NASA.persons ( id, LastName, FirstName, City, State) values (9, "Hodge", "John", "Houston", "TX");'
echo""
read -p "Press any key to continue inserts" -n 1 -s
mysql -u haproxy --host=192.168.144.20 -e 'insert into NASA.persons ( id, LastName, FirstName, City, State) values (10, "Puddy", "Don", "Houston", "TX");'
echo""
read -p "Press any key to continue inserts" -n 1 -s
mysql -u haproxy --host=192.168.144.20 -e 'insert into NASA.persons ( id, LastName, FirstName, City, State) values (11, "Lewis", "Charles", "Houston", "TX");'
echo""
read -p "Press any key to continue inserts" -n 1 -s
